...
def test_profile_empty_body_returns_validation_error(mocker, api_client):
    ...
    r = api_client.patch(PROFILE_PATH.format(profile_id=profile_id), json=None)
    ...
    assert data["details"] == [{"field": "body", "code": "REQUIRED"}]
