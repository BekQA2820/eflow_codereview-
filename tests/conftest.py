...
def api_client():
    class API:
        ...
        def post(self, path, json=None, json_body=None, headers=None):
        ...
        def put(self, path, json=None, json_body=None, headers=None):
            return requests.put(
                f"{self.base}{path}",
                json=json if json is not None else json_body,
                headers=headers or {},
        ...
        def patch(self, path, json=None, json_body=None, headers=None):
