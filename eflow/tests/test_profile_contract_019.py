...
def test_profile_contract_019_field_not_allowed_in_error_response(mocker, api_client):
    """
    PROFILE CONTRACT 019
    Проверка ошибки на наличие неразрешенного поля в запросе
    """
    ...
    assert response.json()["details"][0]["code"] == "FIELD_NOT_ALLOWED"