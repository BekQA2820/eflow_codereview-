...
def test_specialty_sz_immutable_via_verification_token(mocker, api_client):
    ...
    error_body = {
        "code": "FORBIDDEN",
        "message": "specialty_sz cannot be modified via verification token",
        "details": [
    ...
    r = api_client.patch(
        ...
        json={"specialty_sz": "new-specialty"},
    )
