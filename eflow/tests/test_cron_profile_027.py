...
def test_cron_profile_027_forbidden_on_empty_roles(mocker, api_client):
    resp = make_json_response(
        ...
        body={
            ...
            "details": [],
            "traceId": "trace-403-empty-roles-repeat",
        },
        headers={"X-Request-ID": "trace-403-empty-roles-repeat"},
    )
