...
def test_profile_forbid_sql_injection_patterns(mocker, api_client):
    """
    PROFILE SEC 072
    Запрет SQL-инъекций в текстовых полях профиля
    """
    ...
    r = api_client.patch(
        ...
        json={"displayName": "Robert'); DROP TABLE profiles;--"},
    )
    ...
    assert data["details"][0] == {
        "field": "displayName",
        "code": "SQL_INJECTION_NOT_ALLOWED",
    }
