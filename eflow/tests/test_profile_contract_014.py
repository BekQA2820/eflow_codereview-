...
def test_profile_contract_014_invalid_field(mocker, api_client):
    """
    PROFILE CONTRACT 014
    Проверка ошибки при передаче недопустимого поля
    """
    ...
    r = api_client.post(
        ...
        json={"name": "Jane Doe", "extraField": "value"}
    )
    ...
    assert data["details"] == [{"field": "extraField", "code": "FIELD_NOT_ALLOWED"}]
