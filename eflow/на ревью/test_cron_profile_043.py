...
def test_cron_profile_043_forbidden_when_no_access_rights(mocker, api_client):
    ...
    body = {
        ...
        "details": [],
        "traceId": "trace-403-no-access-rights",
    }

    resp1 = make_json_response(
        status=403,
        body=body,
        headers={"X-Request-ID": "trace-403-no-access-rights"},
    )
