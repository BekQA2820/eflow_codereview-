...
def test_cron_profile_025_not_found_when_profile_id_absent(mocker, api_client):
    resp = make_json_response(
        ...
        body={
            ...
            "details": [],
            "traceId": "trace-404-profile-absent",
        },
        headers={"X-Request-ID": "trace-404-profile-absent"},
    )
