...
def test_cron_profile_021_display_name_is_deterministic(mocker, api_client):
    body = {
        "code": "SUCCESS",
        "message": "ok",
    ...
    resp_first = make_json_response(
        status=200,
        body=body,
        headers={"X-Request-ID": "trace-200-displayname-1"},
    )
    resp_second = make_json_response(
        status=200,
        body=body,
        headers={"X-Request-ID": "trace-200-displayname-2"},
    )
